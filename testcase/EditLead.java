...
public class EditLead extends BaseClass {
	...
	@Test(dataProvider="provideData", dependsOnMethods="testcase.CreateLead.runCreateLead")
	...
	public String[][] provideData() throws IOException {
		...
		return ReadExcel.readData("EditLead"); //can call static method directly using ClassName.MethodName
	}
	*/
}
